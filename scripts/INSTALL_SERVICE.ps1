...
Write-Host "Служба $serviceName успешно зарегистрирована и настроена (тип запуска: Автоматически)!" -ForegroundColor Green
Write-Host "Служба НЕ запущена. Для запуска выполните: Start-Service $serviceName" -ForegroundColor Cyan